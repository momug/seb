...
buttons.addEventListener('click', function (event) {
  ...
  if (target.matches('button')) {
    ...
    if (action === 'calculate') {
      console.log('계산 버튼');
      let l = document.querySelector('.calculator__operend--left').textContent;
      let r =  document.querySelector('.calculator__operend--right').textContent;
      let o = document.querySelector('.calculator__operator').textContent;
      document.querySelector('.calculator__result').textContent = calculate(l, o, r);
    }
  }
});
